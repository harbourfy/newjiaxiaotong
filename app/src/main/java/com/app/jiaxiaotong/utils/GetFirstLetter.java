...
public class GetFirstLetter {
    ...
    public static String getFristChar(String text){
        char result = Char2Initial(text.charAt(0));
        // 对英文字母的处理：小写字母转换为大写，大写的直接返回
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(cn2py("么么哒"));
        System.out.println(cn2py("这是干什么"));
        System.out.println(cn2py("hello"));
        System.out.println(getFristChar("重庆重视发展IT行业，大多数外企，如，IBM等进驻山城"));
        System.out.println(getFristChar("么么哒"));
        System.out.println(getFristChar("这是干什么"));
        System.out.println(getFristChar("hello"));
    }
}
