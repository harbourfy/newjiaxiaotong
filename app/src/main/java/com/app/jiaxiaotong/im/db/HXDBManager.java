        ...
        if (db.isOpen()) {
            ...
            for (User user : contactList) {
                ...
                if(user.getMobilePhone() != null)
                    values.put(UserDao.COLUMN_MOBILE_PHONE, user.getMobilePhone());
    ...
    synchronized public Map<String, User> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                String mobilePhone = cursor.getString(cursor.getColumnIndex(UserDao.COLUMN_MOBILE_PHONE));
                String gender =  cursor.getString(cursor.getColumnIndex(UserDao.COLUMN_NAME_GENDER));
                User user = new User();
