...
import com.app.jiaxiaotong.activity.VideoCallActivity;
import com.app.jiaxiaotong.activity.VoiceCallActivity;
...
import com.app.jiaxiaotong.im.model.HXNotifier;
import com.app.jiaxiaotong.im.model.HXSDKModel;
import com.app.jiaxiaotong.im.receiver.CallReceiver;
...
public class MyHXSDKHelper extends HXSDKHelper {
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((MyHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((MyHXSDKModel) hxModel).getDisabledIds();
                }
	...
	public Map<String, RobotUser> getRobotList() {
		if (getHXId() != null && robotList == null) {
			robotList = ((MyHXSDKModel) getModel()).getRobotList();
		}
		return robotList;
	}
    ...
    public void saveContact(User user){
    	...
    	((MyHXSDKModel) getModel()).saveContact(user);
    }
    ...
    public void updateContactList(List<User> contactInfoList) {
        ...
        ((MyHXSDKModel)getModel()).saveContactList(mList);
    }
