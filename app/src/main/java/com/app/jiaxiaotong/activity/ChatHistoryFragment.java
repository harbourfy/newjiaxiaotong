...
import com.app.jiaxiaotong.adapter.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// contact list
		contactList = ((MyHXSDKHelper) HXSDKHelper.getInstance()).getContactList();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (adapter.getItem(position).getUsername().equals(AppContext.getAppContext().getUserName()))
