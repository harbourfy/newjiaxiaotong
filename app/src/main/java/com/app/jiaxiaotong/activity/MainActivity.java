...
public class MainActivity extends BaseActivity implements EMEventListener,OnMessageIsReadListener {
    protected static final String TAG = "MainActivity";
    // 未读消息textview
    private TextView unreadLabel,unreadPushMsg;
    // 未读通讯录textview
...
//                userlist.put(Constant.CHAT_ROBOT, robotUser);
    ...
    private void initView() {
        ...
        unreadPushMsg = (TextView) findViewById(R.id.unread_push_msg_number);
        unreadAddressLable = (TextView) findViewById(R.id.unread_address_number);
        if (!PushMsgKeeper.isRead(this))
            unreadPushMsg.setVisibility(View.VISIBLE);
        mTabs = new Button[4];
    ...
    public void onTabClicked(View view) {
        ...
        if (currentTabIndex != index) {
            ...
            if (!fragments[index].isAdded()) {
                if (index == 3){
                    trx.add(R.id.fragment_container, fragments[index],"mine");
                }else
...
//					unreadAddressLable.setText(String.valueOf(count));
    ...
    @Override
    public void messageIsRead(boolean isRead) {
        if (isRead){
            unreadPushMsg.setVisibility(View.INVISIBLE);
        }else unreadPushMsg.setVisibility(View.GONE);
    }
    ...
    public void onAttachFragment(Fragment fragment) {
        ...
        if (fragment instanceof RefreshListener)
            refreshListener = (RefreshListener) fragment;
    }
